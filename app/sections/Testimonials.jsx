  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center gap-6 md:gap-7">
        ...
        <article
          ref={featuredRef}
          className="group relative w-full overflow-hidden rounded-2xl border border-black-50 bg-gradient-to-br from-black-100 to-black-200/30 p-5 md:p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-[#61DAFB]/30 hover:shadow-[0_20px_48px_rgba(0,0,0,0.4)]"
        >
          ...
          <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-start md:gap-6">
            ...
            <div className="edu-featured-content flex-1 space-y-2">
              <div className="flex flex-wrap items-center gap-2">
                <span className="edu-pursuing-badge inline-flex items-center gap-1.5 rounded-full border border-[#61DAFB]/40 bg-[#61DAFB]/10 px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-[#61DAFB]">
                  <span className="size-1.5 rounded-full bg-[#61DAFB] edu-pulse-dot" />
                  Currently Pursuing
                </span>
                <span className="text-xs text-white-50/70">{featured.period}</span>
              </div>
              <h3 className="text-lg md:text-xl font-bold text-white transition-colors duration-300 group-hover:text-[#61DAFB]/90">
                {featured.name}
              </h3>
              <p className="text-sm font-medium text-white-50">
                {featured.institution}
              </p>
              <p className="text-sm leading-relaxed text-white-50/80">
                {featured.review}
              </p>
            </div>
          </div>
        ...
        >
          {restItems.map((item, index) => {
            ...
            return (
              <article
                key={item.name}
                className="edu-card group relative flex flex-col gap-3 overflow-hidden rounded-2xl border border-black-50 bg-black-100 p-4 md:p-5 transition-all duration-300 hover:-translate-y-1.5 hover:border-white/15 hover:shadow-[0_14px_36px_rgba(0,0,0,0.35)]"
              >
                <div
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1 space-y-1">
                    ...
                    <h3 className="text-sm md:text-base font-bold text-white leading-snug transition-colors duration-300 group-hover:text-white-50">
                      {item.name}
                    </h3>
                ...
                <p className="relative z-10 text-xs sm:text-sm leading-relaxed text-white-50/75 line-clamp-3 border-t border-black-50 pt-2.5">
                  {item.review}
                </p>
              </article>
            );
